...
public:
	...
	*/
	...
	int GetSequenceActivity(int sequence)
	{
		...
		DWORD getSequenceActivity = (DWORD)utilities::pattern_scan("client.dll", "55 8B EC 53 8B 5D 08 56 8B F1 83");

		static auto get_sequence_activity = reinterpret_cast<int(__fastcall*)(void*, studio_hdr_t*, int)>(getSequenceActivity);
