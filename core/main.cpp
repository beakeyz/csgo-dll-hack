...
unsigned long WINAPI initialize(void *instance)
{
	...
	c_mode_picker rb_selection(&ragebot_box, -1, "Selection", render::fonts::watermark_font_small, c_ragebot::get_ptr()->sort_mode_map, "Health", c_ragebot::get_ptr()->curent_sort_mode, 12);

	groupBox PlayerEspBox(e_position::LEFT, 80, 0, render::fonts::watermark_font_other, "Player esp", e_boxtype::PLAYER_ESP, 0);

	c_button_classifier target_type(&PlayerEspBox, {{0, 0, 0, 0, 0, "General"}, {0, 0, 0, 0, 1, "Models"}, {0, 0, 0, 0, 2, "Extra"}}, "", render::fonts::watermark_font_other, 0);
	...
	buttonComponent skeleton_esp(&PlayerEspBox, 2, "Teammate skeleton", render::fonts::watermark_font_small, c_skeleton_esp::get_ptr()->teammates, 31);
	buttonComponent skeleton_esp_enemies(&PlayerEspBox, 2, "Enemy  skeleton", render::fonts::watermark_font_small, c_skeleton_esp::get_ptr()->enemies, 32);
	c_mode_picker seketon_esp_color_team(&PlayerEspBox, 2, "Team skeleton color", render::fonts::watermark_font_small, c_skeleton_esp::get_ptr()->color_map, "Green", c_skeleton_esp::get_ptr()->team_color, 33);
	c_mode_picker seketon_esp_color_enemy(&PlayerEspBox, 2, "Enemy skeleton color", render::fonts::watermark_font_small, c_skeleton_esp::get_ptr()->color_map, "Red", c_skeleton_esp::get_ptr()->enemy_color, 34);

	c_button_spacer lol_spacer(&PlayerEspBox, 2, 25, 35);

	buttonComponent glow_esp(&PlayerEspBox, 2, "Teammate glow", render::fonts::watermark_font_small, c_skeleton_esp::get_ptr()->teammates, 36);
	buttonComponent glow_esp_enemies(&PlayerEspBox, 2, "Enemy  glow", render::fonts::watermark_font_small, c_skeleton_esp::get_ptr()->enemies, 37);
	c_mode_picker glow_esp_color_team(&PlayerEspBox, 2, "Team glow color", render::fonts::watermark_font_small, c_skeleton_esp::get_ptr()->color_map, "Green", c_skeleton_esp::get_ptr()->team_color, 38);
	c_mode_picker glow_esp_color_enemy(&PlayerEspBox, 2, "Enemy glow color", render::fonts::watermark_font_small, c_skeleton_esp::get_ptr()->color_map, "Red", c_skeleton_esp::get_ptr()->enemy_color, 39);

	groupBox worldesp_box(e_position::LEFT, 80, 0, render::fonts::watermark_font_other, "World esp", e_boxtype::VISUALS, 1);

	c_button_classifier worldesp_type(&worldesp_box, { {0,0,0,0,0,"General"}, {0,0,0,0,1,"Extra"} }, "", render::fonts::watermark_font_other, 0);

	buttonComponent dropped_weapons(&worldesp_box, 0, "Dropped weapons", render::fonts::watermark_font_small, c_visuals::get().m_edit_smoke, 1);
	c_mode_picker dropped_weapons_ammo_color(&worldesp_box, 0, "", render::fonts::watermark_font_other, c_visuals::get().color_map, "White", c_visuals::get_ptr()->dropped_weapon_ammo_color, 2);
	buttonComponent dropped_weapons_ammo(&worldesp_box, 0, "Dropped weapons ammo", render::fonts::watermark_font_small, c_visuals::get().m_edit_smoke, 3, &dropped_weapons_ammo_color);
	buttonComponent Projectiles(&worldesp_box, 0, "Projectiles", render::fonts::watermark_font_small, c_visuals::get_ptr()->projectiles, 4);
	buttonComponent Projectile_prediction(&worldesp_box, 0, "Projectile prediction", render::fonts::watermark_font_small, c_visuals::get_ptr()->projectile_prediction, 5);

	buttonComponent edit_smoke(&worldesp_box, 1, "edit smoke", render::fonts::watermark_font_small, c_visuals::get().m_edit_smoke, 6);
	c_slider_component nightmode(&worldesp_box, 1, "Nightmode", render::fonts::watermark_font_small, c_visuals::get_ptr()->m_nightmode, .1f, 100, 7);


	groupBox effects_box(e_position::LEFT, 80, 0, render::fonts::watermark_font_other, "Effects", e_boxtype::PLAYER_ESP, 2);

	buttonComponent remove_visual_recoil(&effects_box, -1, "remove visual recoil", render::fonts::watermark_font_small, c_visuals::get().visual_recoil, 0);
	...
	buttonComponent bhop(&gen_misc_box, -1, "bhop", render::fonts::watermark_font_small, movement::bunny_hop::isEnabled, 2);
	...
	c_menu::get_ptr()->visuals_btn.m_boxes[worldesp_box.index] = &worldesp_box;
	c_menu::get_ptr()->visuals_btn.m_boxes[effects_box.index] = &effects_box;
